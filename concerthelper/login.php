...
/*
    ...
    File Description: Handles user sign-in and routes members and administrators to their dashboards.
*/
    ...
    if ($email === "" || $password === "") {
        ...
        if ($role === null) {
            ...
            try {
                ...
                $memberId = null;
                $errors[] = "Member lookup failed. Confirm the database is set up with database/concerthelper_schema.sql.";
            }
